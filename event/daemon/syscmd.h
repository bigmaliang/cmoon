...
#define CASE_SYS_CMD(cmd, q, cd, db, fp, ret)               \
    {                                                       \
    case REQ_CMD_CACHE_GET:                                 \
        ret = sys_cmd_cache_get(q, cd, db, fp, false);      \
        break;                                              \
    case REQ_CMD_CACHE_SET:                                 \
        ret = sys_cmd_cache_set(q, cd, db, fp, false);      \
        break;                                              \
    case REQ_CMD_CACHE_DEL:                                 \
        ret = sys_cmd_cache_del(q, cd, db, fp, false);      \
        break;                                              \
    case REQ_CMD_CACHE_EMPTY:                               \
        ret = sys_cmd_cache_empty(q, &cd, db, fp, false);   \
        break;                                              \
    }
