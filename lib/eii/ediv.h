...
enum {
    ...
    EDIV_SOPT_ONLY_MINMATCH = (1 << 1), /* step to next char, whenever matched */
    EDIV_SOPT_THROW_UNKNOWN = (1 << 2), /* throw away chars not in dictionary */
    EDIV_SOPT_SKIP_NUTF = (1 << 3)      /* don't split non utf8 chinese characters */
};
